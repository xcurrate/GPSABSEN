...
// ⚠️  Service Role Key — dipakai HANYA untuk Admin API (buat user baru).
//     Ambil dari: Supabase Dashboard → Settings → API → service_role (secret)
//     JANGAN expose key ini ke publik pada aplikasi production.
//     Untuk production, pindahkan pemanggilan Admin API ke server/Edge Function.
const SUPABASE_SERVICE_ROLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.SERVICE_ROLE_KEY_ANDA';
